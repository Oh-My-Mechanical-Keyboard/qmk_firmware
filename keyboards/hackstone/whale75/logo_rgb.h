...
#define BOX_LED_FIRST 6
#define BOX_LED_NUM   29

#define BOX_LED_MAX_V 200
#define BOX_LED_VAL_STEP 65

#define BOX_LED_MAX_S 60
#define BOX_LED_SPEED_STEP 15
...
void corner_rgb_matrix_task(void);
...
void rgb_box_val_set(uint8_t val);
uint8_t rgb_box_val_get(void);

void rgb_box_speed_step(bool back);
void rgb_box_speed_set(uint8_t speed);
