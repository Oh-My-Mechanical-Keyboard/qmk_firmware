...
/* USB */
#define MANUFACTURER "JY"
#define PRODUCT "Whale75"
#define VENDOR_ID 0xAA96
#define PRODUCT_ID 0xAA28
...
#define BOX_LED_CONFIG_KB_SIZE 10 // 10个字节的灯条信息
...
#define MATRIX_COL_PINS \
    { B1, B0, C5, C4, A7, A6, A5, C9, A8, C10, C11, C12, D2, B3, B4, B6 }
...
// enabled only if RGB_MATRIX_FRAMEBUFFER_EFFECTS is defined // 互动效果
// #define ENABLE_RGB_MATRIX_TYPING_HEATMAP
// #define ENABLE_RGB_MATRIX_DIGITAL_RAIN
// enabled only of RGB_MATRIX_KEYPRESSES or RGB_MATRIX_KEYRELEASES is defined // 互动效果
