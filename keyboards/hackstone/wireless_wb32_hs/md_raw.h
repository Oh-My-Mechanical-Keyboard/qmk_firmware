...
#define _temp_rhs_21  replaced_hid_send  // raw_hid.h
#define _temp_rhs_53  replaced_hid_send // via.c
#define _temp_rhs_133  replaced_hid_send // via.c
#define _temp_rhs_136  replaced_hid_send // via.c
#define _temp_rhs_182 replaced_hid_send // via.c
#define _temp_rhs_185  replaced_hid_send // via.c
#define _temp_rhs_198  replaced_hid_send // via.c
#define _temp_rhs_199  replaced_hid_send // via.c
...
#define _temp_rhs_200  replaced_hid_send // via.c
